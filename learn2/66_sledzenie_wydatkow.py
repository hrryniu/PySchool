...
def add_expense(month):
    ...
    expense_type= input("Podaj typ wydatku (kedzenie, rozrywka, dom,inny): ")

    expense = (expense_amount,expense_type, month) #zapisujemy wydatki do tupli- nie możne tego już podyfikować
...
def show_stats(month):
    ...
    print("Średni wydatek w tych miesiącu: ", average_expense_this_month)
